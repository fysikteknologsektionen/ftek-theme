...
?>
	<footer id="page-footer">
		<div id="footer-contact">
			<ul>
				<li><a href="<?= get_page_link(124) ?>" title="<?= get_the_title(124) ?>"><?= bloginfo('name') ?></a></li>
				<li><?= __('Org. no', 'ftek') ?>: 857208-8477</li>
				<li>Email: <a href="mailto:info@ftek.se" target="_blank">info@ftek.se</a></li>
				<li><?= __('Visitor address', 'ftek') ?>: <a href="https://www.google.com/maps/place/Focus/@57.690859,11.9751408,19z/data=!4m5!3m4!1s0x464ff373530bf8cd:0xb31fc4afa7529106!8m2!3d57.6910046!4d11.975559" target="_blank">Focus, Kemivägen 11, 412 58 Göteborg</a></li>
				<li><?= __('Mailing address', 'ftek') ?>: <a href="https://www.google.com/maps/place/Fysikgränd+3,+411+33+Göteborg/" target="_blank">Fysikgränd 3, 411 33 Göteborg</a></li>
